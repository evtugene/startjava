...
// В задаче номер 4 сначала я решил  сделать декремент, так как изначальные значения уже максимальные.
// А потом сделал инкремент и вернулся к исходным значениям.
